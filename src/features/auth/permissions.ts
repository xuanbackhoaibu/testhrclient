...
const PERMISSION_ALIASES: Record<string, string[]> = {
  ...
  'admin.authority.read': [
    ...
    AUTH_ADMIN_PERMISSIONS.PERMISSIONS_READ,
    AUTH_ADMIN_PERMISSIONS.PERMISSION_GROUPS_READ,
  ],
  ...
  'admin.users.read': [AUTH_ADMIN_PERMISSIONS.USERS_READ],
  'admin.users.write': [AUTH_ADMIN_PERMISSIONS.USERS_READ, AUTH_ADMIN_PERMISSIONS.USERS_UPDATE],
  'admin.users.lock': [AUTH_ADMIN_PERMISSIONS.USERS_UPDATE],
  'admin.users.unlock': [AUTH_ADMIN_PERMISSIONS.USERS_UPDATE],
  'admin.users.deactivate': [AUTH_ADMIN_PERMISSIONS.USERS_UPDATE],
  'admin.users.revoke_sessions': [AUTH_ADMIN_PERMISSIONS.USERS_REVOKE_SESSIONS],
  ...
  'auth.user.read': [AUTH_ADMIN_PERMISSIONS.USERS_READ],
  'auth.user.manage': [
    AUTH_ADMIN_PERMISSIONS.USERS_READ,
    AUTH_ADMIN_PERMISSIONS.USERS_UPDATE,
    AUTH_ADMIN_PERMISSIONS.USERS_PROVISION,
  ...
  'auth.user.provision': [AUTH_ADMIN_PERMISSIONS.USERS_PROVISION],
  'auth.user.update_status': [AUTH_ADMIN_PERMISSIONS.USERS_UPDATE],
  'auth.user.revoke_sessions': [AUTH_ADMIN_PERMISSIONS.USERS_REVOKE_SESSIONS],
  'auth.user.send_activation': [AUTH_ADMIN_PERMISSIONS.USERS_SEND_ACTIVATION],
  'auth.user.assign_role': [AUTH_ADMIN_PERMISSIONS.ROLES_ASSIGN],
  'auth.user.assign_permission': [AUTH_ADMIN_PERMISSIONS.PERMISSIONS_ASSIGN],
  'auth.role.read': ['admin.authority.read', AUTH_ADMIN_PERMISSIONS.ROLES_READ],
  'auth.role.manage': [AUTH_ADMIN_PERMISSIONS.ROLES_READ, AUTH_ADMIN_PERMISSIONS.ROLES_ASSIGN],
  'auth.permission.read': [
    'admin.authority.read',
    AUTH_ADMIN_PERMISSIONS.PERMISSIONS_READ,
    AUTH_ADMIN_PERMISSIONS.PERMISSION_GROUPS_READ,
