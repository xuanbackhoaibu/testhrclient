...
export function EmployeesPage() {
  ...
  const employeeSummary = useMemo(() => {
    ...
    return {
      ...
      newHires: employees.filter((employee) => {
  ...
  const visibleEmployees = useMemo(() => {
    ...
    switch (quickFilter) {
      ...
      case "newHires":
        // Khong co API filter theo khoang ngay vao lam nen loc o client dua
        // tren hireDate da co san trong du lieu, khong bia field moi.
            ...
            <Box className="employee-quick-filter-scroll">
              <SegmentedControl
                ...
                data={[
                  ...
                  {
                    value: "newHires",
                    label: `Mới trong tháng (${employeeSummary.newHires})`,
                  },
                ]}
